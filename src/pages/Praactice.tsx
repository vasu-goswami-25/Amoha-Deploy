...
//       solved: questionsList.filter((q) => q.difficulty === "Easy" && q.solved)
//         .length,
//     },
//     Medium: {
//       total: questionsList.filter((q) => q.difficulty === "Medium").length,
//       solved: questionsList.filter((q) => q.difficulty === "Medium" && q.solved)
//         .length,
//     },
//     Hard: {
//       total: questionsList.filter((q) => q.difficulty === "Hard").length,
//       solved: questionsList.filter((q) => q.difficulty === "Hard" && q.solved)
//         .length,
//     },
//   };
...
//       case "Binary Search":
//       case "Binary Search on 2D Arrays":
//         return darkMode
